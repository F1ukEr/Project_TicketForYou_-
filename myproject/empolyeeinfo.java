 ...
 * @author user
 */
public class empolyeeinfo extends javax.swing.JFrame {
    ...
    public empolyeeinfo() {
        ...
        try {
          ...
          //  r = s.executeQuery("Select ID,Name,Surname,Address,Tel,Position,Brithday from admin");
            r = s.executeQuery("Select * from admin  union   Select * from employee");
            r.first();
            ...
            for (int i = 0; i < countrow; i++) {
                data[i][0] = r.getString("idemployee");
                data[i][1] = r.getString("Name");
                data[i][2] = r.getString("Surname");
                data[i][3] = r.getString("Address");
                data[i][4] = r.getString("Tel");
                data[i][5] = r.getString("Position");
                data[i][6] = r.getString("Brithday");
                r.next();
            }
            jTable1.setModel(new javax.swing.table.DefaultTableModel(data, new String[]{"ID ", "Name", "Surname", "Address", "Tel", "Position", "Brithday"}));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Surname", "Tel", "Address", "Position", "BrithDay"
            }
        ));
        ...
        setSize(new java.awt.Dimension(718, 437));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(empolyeeinfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new empolyeeinfo().setVisible(true);
            }
        });
    }
