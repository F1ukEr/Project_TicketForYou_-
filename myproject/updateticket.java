...
public class updateticket extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            r = s.executeQuery("Select * from ticket where idshow=" + Integer.parseInt(jTextField1.getText()));
            r.first();
            jTextField2.setText(r.getString("nameshow"));
            jTextField3.setText(r.getString("dateshow"));
            jTextField4.setText(r.getString("time"));
            jTextField5.setText(r.getString("price"));
            jTextField6.setText(r.getString("seat"));
        } catch (Exception e) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE ticket SET nameshow='"
                    + jTextField2.getText() + "', dateshow='"
                    + jTextField3.getText() + "', time='"
                    + jTextField4.getText() + "', price='"
                    + jTextField5.getText() + "', seat='"
                    + jTextField6.getText() + "' WHERE idshow="
